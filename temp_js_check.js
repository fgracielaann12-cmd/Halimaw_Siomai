    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        window.submitStockRequestModal = async function() {
            try {
                ...
                // Try to get latest CSRF from cookie if available
                ...
                console.error(err);
                alert("CRITICAL JAVASCRIPT ERROR: " + err.message);
                const submitBtn = document.querySelector("#stockRequestFormModal button[type='submit']");
                if (submitBtn) {
                    submitBtn.disabled = false;
                    submitBtn.innerHTML = '<i class="bi bi-send me-2"></i>Submit Stock Request';
                }
