...
class Userdashboard extends BaseController
{
    ...
    public function store()
    {
        ...
        if ($file && $file->isValid() && !$file->hasMoved()) {
            ...
            if (!empty($rows)) {
                ...
                $header = $rows[0];
                // If header looks like strings (product\_id/name), drop it
                $isHeader = false;
    ...
    public function expired()
    {
        ...
        return view('user/expired_items', [
            'items' => $expiredItems,
    ...
    public function expiringSoon()
    {
        ...
        return view('user/userexpiringsoon', $data);
    }
    ...
    public function deleted()
    {
        ...
        return view('user/deleteditems', $data);
    }
