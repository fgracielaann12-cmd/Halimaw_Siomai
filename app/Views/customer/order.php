...
<head>
    ...
    <title>Order Now | Halimaw POS Inventory System</title>
    <!-- Bootstrap 5.3 -->
...
<body>
    ...
    <nav class="top-navbar">
        <div class="navbar-brand">
            ...
            Halimaw POS Inventory System Online <span style="color: #6c757d; font-weight: 500; margin-left: 5px;">| Menu</span>
        </div>
        <div>
    ...
    <div class="checkout-fullscreen" id="checkoutFullscreen">
        <div class="checkout-left">
            <div class="checkout-header">
                ...
                <h2>Halimaw POS Inventory System Online</h2>
            </div>
    ...
    <script>
        ...
        function openModal(productId) {
            ...
            if (product.isSiomai) {
                ...
                const variations = [
                    { id: 'Small', name: 'Small', pcs: 12, price: product.pack_small_price, stock: product.pack_small_qty },
                    { id: 'Medium', name: 'Medium', pcs: 20, price: product.pack_medium_price, stock: product.pack_medium_qty },
                    { id: 'Large', name: 'Large', pcs: 40, price: product.pack_biggest_price, stock: product.pack_biggest_qty }
                ];
