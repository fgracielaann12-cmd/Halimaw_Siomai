...
<head>
    ...
    <style>
        ...
        .search-bar-container .search-box {
            display: flex;
            align-items: center;
            gap: 10px; /* <-- This adds the space between input and button */
            width: 100%;
            max-width: 350px;
        }
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto gap-3">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active" href="<?= site_url('items/expiringSoon') ?>">Expiring Soon</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="<?= site_url('items/deleted') ?>">Expired</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="<?= site_url('items/logs') ?>"> Logs </a>
                <li class="nav-item">
...
<div class="container mt-5">
  ...
  <div class="position-relative" style="width: 250px;">
    ...
    <input type="text" id="searchQuery" 
           class="form-control ps-4 rounded-pill shadow-sm" 
           placeholder="Search by item name" 
           oninput="searchItems()"
           style="border: 1px solid #ced4da; transition: all 0.25s ease;"></div>
